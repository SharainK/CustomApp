...
//since the data is being passed b/w the activities we need to have Parcelable implemented
public class CourseRVModal implements Parcelable {
    ...
    //we need to have an empty constructor to perform Firebase CRUD operations
    //without empty constructor there are issues which has been discussed in the report.
    public CourseRVModal() {
    //this is required for calls to DataSnapshot.getValue()
    }
...
//this is the constructor which has been used to initialise the fields.
    public CourseRVModal(String courseName, String courseId, String courseDescription, String coursePrice, String bestSuitedFor, String courseImg, String courseLink) {
        this.courseName = courseName;
        this.courseId = courseId;
        this.courseDescription = courseDescription;
        this.coursePrice = coursePrice;
